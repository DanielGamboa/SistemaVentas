...
return new class extends Migration
{
     ...
     * falls within the current week. If it does, the triggers update the count_week column in addition to the count column. 
     ...
     * 
     * These triggers use the IF(count > 0, count - 1, 0) and IF(count_week > 0, count_week - 1, 0) expressions to ensure that count
     * and count_week never go below 0. If the current value is greater than 0, it subtracts 1; otherwise, it sets the value to 0.
     * 
    ...
    public function up(): void
    {
        ...
        //         IF WEEK(NEW.created_at, 1) = WEEK(CURDATE(), 1) THEN
        ...
        //             IF WEEK(OLD.created_at, 1) = WEEK(CURDATE(), 1) THEN
        //                 UPDATE estatus_count
        //                 SET count = count - 1,
        //                     count_week = count_week - 1
        ...
        // ');
            ...
            //                     count_week = IF(count_week > 0, count_week - 1, 0)
            //                 WHERE estatus COLLATE utf8mb4_unicode_ci = old_estatus_value COLLATE utf8mb4_unicode_ci;
            //             END IF;
